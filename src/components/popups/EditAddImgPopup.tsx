...
const EditAddImgPopup = ({ name, id, url, isModalOpen, setIsModalOpen, display}: EditPopupProps) => {
    const { t } = useTranslation();
    const closeModal = () => setIsModalOpen(false);
    const initialValues: CategoryValues = { name: name||'', thumbnail: '' };
                  ...
                  <Form>
                    ...
                    <div className="mt-6 mb-14">
                      <label className="mb-2.5 flex font-medium text-black dark:text-white">
                        {t('popup.img')} <FaAsterisk className='text-[8px] text-[#E02828]' />
                      </label>
                      <div className="">
                        <Field
                          type="file"
