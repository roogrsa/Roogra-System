...
const BannerPopup = ({ name, id, isModalOpen, bannerUrl, duration, image, setIsModalOpen, display }: SettingsPopupProps) => {
    console.log(id);
                    ...
                    <div className="relative p-4 w-full max-w-md max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                >
                                    {({ isSubmitting,setFieldValue }: FormikProps<BannerValues>) => (
                                        <Form>
                                            <InputText
                                                type={`text`}
                                                name={`name`}
