...
import userSix from './../../../public/person.jpeg';
  ...
  return (
    <>
      ...
      <div className="overflow-hidden">
        ...
        <div className="px-4 pb-4 text-center lg:pb-6 xl:pb-11.5">
        ...
        <div className=" flex justify-end   gap-x-5">
          <div className="bg-SaveIconBg rounded-md">
            <img
              src={SaveIconSrc}
              className="w-6 h- text-center p-1 cursor-pointer"
          ...
          <div className="bg-BlockIconBg rounded-md">
            <img
              ...
              //   !loading &&
              //   user.id &&
              //   useHandleBan(user.id, user.isBanned === 1, banUser)
              // }
            />
          </div>
